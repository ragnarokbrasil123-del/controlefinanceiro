      ...
      <div className="flex items-center gap-3.5 flex-1 min-w-0">
        ...
        <div className="flex-1 w-full">
          <div className="flex flex-col justify-center mb-0.5">
            <h4 className={`font-semibold text-sm ${isPaid === false ? 'text-amber-100' : 'text-white'}`}>{title || "Sem título"}</h4>
            {isPaid === false && <span className="bg-amber-500/20 text-amber-400 text-[10px] px-1.5 py-0.5 rounded-md font-bold uppercase tracking-wider w-fit mt-1">Pendente</span>}
          </div>
